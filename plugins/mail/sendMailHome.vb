...
Sub submit_click(sender As Object, e As EventArgs)
	...
	If rValidate = True Then
		...
		mail.From = New MailAddress("DONOTREPLY@GlassVentures.com") 
		mail.To.Add("tj@aaronrich.com")
	'mail.To.Add("linden@aaronrich.com")
	'mail.CC.Add("")
	mail.BCC.Add("webadmin@aaronrich.com")

		mail.Subject = "NEW MESSAGE via GlassVentures.com"
	...
	"<strong>Message: </strong>" & contactMessage.value
		...
		Try
			smtp.Credentials = New NetworkCredential("DONOTREPLY@GlassVentures.com", "000215")
			smtp.Send(mail)
...
Private Function IsGoogleCaptchaValid() As Boolean
    ...
    Try
        If Not String.IsNullOrEmpty(recaptchaResponse) Then
            Dim request As Net.WebRequest = Net.WebRequest.Create("https://www.google.com/recaptcha/api/siteverify?secret=6LeiwigaAAAAAGInfwCpkx4Zu1oIxVDyFT5ATWmn&response=" + recaptchaResponse)
            request.Method = "POST"
