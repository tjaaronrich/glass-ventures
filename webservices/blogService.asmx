...
Public Class MapService
    ...
    Public Sub GetAllBlog()
        ...
        Try
            ...
            Dim sQueryString As String = "SELECT * FROM tblnewsftb WHERE Status = 'Active' ORDER BY nNum ASC"
    ...
    Public Sub GetTop3Blog()
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblnewsftb WHERE Status = 'Active' ORDER BY nNum ASC LIMIT 3"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
