...
Public Class MapService
    ...
    Public Sub GetLinksList()
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tbllinks "
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
            ...
            Try
                ...
                While odbcReader.Read()
                    ...
                    xmlString += """linkNum"":""" & Convert.ToInt16(odbcReader("linkNum")) & ""","
                    xmlString += """linkName"":""" & Trim(odbcReader("linkName").ToString) & ""","
                    xmlString += """linkCategory"":""" & Trim(odbcReader("linkCategory").ToString) & ""","
                    xmlString += """URL"":""" & Trim(odbcReader("URL").ToString) & ""","
                    xmlString += """linkDescription"":""" & Trim(odbcReader("linkDescription").ToString) & ""","
                    xmlString += """linkSort"":""" & Trim(odbcReader("linkSort").ToString) & """},"
                End While
...
End Sub
    ...
    <WebMethod> _
    Public Sub DeleteLinks(models As String)

       
        
		Dim x As Object = JsonConvert.DeserializeObject(of Object)(models)
		Dim linkNum = x(0)("linkNum")
		'Dim pageName = x(0)("pageName")
		'Dim content = x(0)("content")
