...
<!--<header id="myCarousel" class="carousel slide" style="height:550px;">-->
	...
	<header id="myCarousel" class="carousel slide" style="height:30%;-webkit-clip-path: polygon(-30% -30%, 100% 0, 100% 92%, 0 100%);">
    	<!-- Indicators -->
    	...
    	<div class="carousel-inner">
        	<div  class="item active">
            	...
            	<div class="fill" style="background-color:#16a6b6;position: relative;z-index: 9;"></div>
            	<div class="fill2" style="background-color:#16a6b6;position: relative;z-index: 9;position: absolute;top:0;"></div>
            	
					<div class="background self-hosted-video-bg" style="max-width: 100%; height: 855px; width: 100%;" data-imgwidth="">
					<video  muted="" autoplay loop preload="auto" style="position: absolute; width: 100%; bottom:0;">
					<source src="https://avada.theme-fusion.com/agency/wp-content/uploads/sites/11/2017/03/video_agency_home.mp4" type="video/mp4">
					</video>
					</div>
