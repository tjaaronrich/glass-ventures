<%@ Page Language="VB" debug="true" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="VB/Login.aspx.vb" Inherits="Login" %>
...
<div class="subpage parallax-container">
  <div class="parallax">
	...
	<img src="/Graphics/sub-header-pages-header.jpg" style="width:100%;" alt="header image">
  </div>
</div>
                    ...
                    <div class="col-lg-12" style="padding-top:10px;">
							<div class="row" style="padding-right:30px;">
								<div class="input-field col-md-12">
								  ...
								  <label style="color:#9e9e9e; margin-left:4rem; width:auto; padding-left: 45px;" for="icon_prefix">Username</label>
								</div>
								<div class="input-field col-md-12">
								  ...
								  <label style="color:#9e9e9e; margin-left:4rem; width:auto; padding-left: 45px;" for="icon_mail">Password</label>
								</div>
							</div>
                    </div>
                    <div class="col-lg-12">
