...
Public Class DAL_GalleryCategories
    ...
    Public Shared Function FileNameExists(ByVal fn As String) As Integer
        ...
        Try
            ...
            Dim sQueryString As String = "SELECT count(*) as FileCount FROM tblgallerycategories WHERE ImageFile = '" & fn & "'"
    ...
    Public Shared Function AddPhoto(ByVal Name As String, ByVal FileName As String, ByVal pgID As Integer, ByVal pgName As String, ByVal Status As String) As Integer
        ...
        Try
            ...
            Dim sQueryString As String = "INSERT INTO tblgallerycategories " & _
            "(Name, " & _
            "ImageFile, " & _
            "pgID, " & _
            "pgName, " & _
    ...
    Public Shared Function ModifyPhoto(ByVal photoID As Integer, ByVal photoName As String, ByVal pgID As Integer, ByVal pgName As String, ByVal photoStatus As String) As Integer
        ...
        Try
            sQueryString = "UPDATE tblgallerycategories SET " & _
                "Name = '" & photoName & "', " & _
                "pgID = " & pgID & ", " & _
                "pgName = '" & pgName & "', " & _
    ...
    Public Shared Function DeletePhoto(ByVal photoID As Integer) As Integer
        ...
        Try
            ...
            sQueryString = "DELETE FROM tblgallerycategories WHERE photoID = " & photoID
    ...
    Public Shared Function GetApprovedImageList() As List(Of PC_Gallery)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblgallerycategories ORDER BY pgName, photoID"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveGalleryLast11() As List(Of PC_Gallery)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblgallerycategories ORDER BY photoID"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveImageList() As List(Of PC_Gallery)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblgallerycategories WHERE Status = 'Active' ORDER BY photoID"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetImageInfoByID(ByVal photoID As Integer) As PC_Gallery
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblgallerycategories WHERE photoID = " & photoID
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
...
#Region "PhotoGallery"
    ...
    Public Shared Function GalleryNameExists(ByVal gn As String) As Integer
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT count(*) as NameCount FROM tblcategoryphotogallery WHERE pgName = '" & gn & "'"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function AddPhotoGallery(ByVal Name As String, ByVal IsDefault As String, ByVal pgYear As String, ByVal Status As String) As Integer
        ...
        Try
            ...
            Dim sQueryString As String = "INSERT INTO tblcategoryphotogallery " & _
            "(pgName, " & _
            "pgDefault, " & _
            "pgYear, " & _
            "pgStatus)" & _
    ...
    Public Shared Function ModifyPhotoGallery(ByVal pgName As String, ByVal pgDefault As String, ByVal pgYear As String, ByVal pgStatus As String, ByVal pgID As Integer) As Integer
        ...
        Try
            sQueryString = "UPDATE tblcategoryphotogallery SET " & _
                "pgName = '" & pgName & "', " & _
    ...
    Public Shared Function ModifyGalleryNameInPhotoTable(ByVal pgID As Integer, ByVal pgName As String) As Integer
        ...
        Try
            sQueryString = "UPDATE tblgallerycategories SET pgName = '" & pgName & "' WHERE pgID = " & pgID.ToString
    ...
    Public Shared Function GetActiveGalleryList() As List(Of PC_PhotoGalleryCategories)

        Dim oList As New List(Of PC_PhotoGalleryCategories)
        Dim counter As Integer = 0

        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcategoryphotogallery where pgStatus = 'Active' ORDER BY pgName ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
            ...
            Try
                ...
                While odbcReader.Read()
                    ...
                    Else
                        oItem.pgName = Trim(odbcReader("pgName").ToString)
                    End If
                    If odbcReader("pgYear").Equals(DBNull.Value) Then
                        oItem.pgYear = ""
                    Else
                        oItem.pgYear = Trim(odbcReader("pgYear").ToString)
                    End If
    ...
    Public Shared Function GetActiveGalleryListYear() As List(Of PC_PhotoGalleryCategories)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcategoryphotogallery where pgStatus = 'Active' and pgYear = '2014' ORDER BY pgName ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetGalleryList() As List(Of PC_PhotoGalleryCategories)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcategoryphotogallery ORDER BY pgName ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
            ...
            Try
                ...
                Dim oItemI As New PC_PhotoGalleryCategories
    ...
    Public Shared Function GetGalleryByID(ByVal pgID As String) As PC_PhotoGalleryCategories
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcategoryphotogallery WHERE pgID = " & pgID
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function DeletePhotoGallery(ByVal pgID As Integer, ByVal pgName As String) As Integer
        ...
        If iRslt = 1 Then
            ...
            Try
                'if deleting a pet, physically delete the record
                sQueryString = "DELETE FROM tblcategoryphotogallery WHERE pgID = " & pgID
    ...
    Public Shared Function DeletePhotoGalleryAssociations(ByVal pgName As String) As Integer
        ...
        Try
            ...
            sQueryString = "DELETE FROM tblgallerycategories WHERE pgName = '" & pgName & "'"
    ...
    Public Shared Function ArchivePhotoGallery(ByVal pgID As String, ByVal pgName As String) As Integer
        ...
        If iRslt = 1 Then
            ...
            Try
                'if deleting a pet, physically delete the record
                sQueryString = "UPDATE tblcategoryphotogallery SET pgStatus = 'Inactive' WHERE pgID = " & pgID
    ...
    Public Shared Function ArchivePhotoGalleryAssociations(ByVal pgName As String) As Integer
        ...
        Try
            'if deleting, physically delete the record
            sQueryString = "UPDATE tblgallerycategories SET status = 'Inactive' WHERE pgName = '" & pgName & "'"
