...
Public Class DAL_Announcements
...
#Region "EventCalendar"
    ...
    Public Shared Function GetActiveCalendarEventsLast01() As List(Of PC_Calendar)
        ...
        Try
            ...
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
	...
	Public Shared Function GetAnnouncementByNum(ByVal cNum As Integer) As PC_Calendar
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE cNum = " & cNum
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast02() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC LIMIT 1,1"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast03() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC LIMIT 2,1"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast04() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC LIMIT 3,1"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetAllCalendarItems() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements ORDER BY Status ASC, StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEvents() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsList() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsListByName(ByVal currentName As String) As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and Title like '%" & Replace(currentName, "'", "''") & "%'"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsList2(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
            ...
            If fStartDate = "ALL" Or fEndDate = "ALL" Then
                sQueryString = "SELECT * FROM tblannouncements WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Else
                sQueryString = "SELECT * FROM tblannouncements WHERE Status = 'Active' and ((StartDate >= '" & fStartDate & "' and StartDate <= '" & fEndDate & "') or (EndDate >= '" & fStartDate & "' and EndDate <= '" & fEndDate & "')) ORDER BY StartDate ASC, StartTime ASC"
            End If
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsListHiring(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
            ...
            'Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            If fStartDate = "ALL" Or fEndDate = "ALL" Then
                sQueryString = "SELECT * FROM tblannouncements WHERE Status = 'Active' and Category = 'Hiring' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Else
                sQueryString = "SELECT * FROM tblannouncements WHERE Status = 'Active' and Category = 'Hiring' and ((StartDate >= '" & fStartDate & "' and StartDate <= '" & fEndDate & "') or (EndDate >= '" & fStartDate & "' and EndDate <= '" & fEndDate & "')) ORDER BY StartDate ASC, StartTime ASC"
            End If
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsListTourney2(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
            ...
            'Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            If fStartDate = "ALL" Or fEndDate = "ALL" Then
                sQueryString = "SELECT * FROM tblannouncements WHERE Status = 'Active' and Category = 'Tournament' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Else
                sQueryString = "SELECT * FROM tblannouncements WHERE Status = 'Active' and Category = 'Tournament' and ((StartDate >= '" & fStartDate & "' and StartDate <= '" & fEndDate & "') or (EndDate >= '" & fStartDate & "' and EndDate <= '" & fEndDate & "')) ORDER BY StartDate ASC, StartTime ASC"
            End If
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetInactiveCalendarEvents() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Inactive' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast5() As List(Of PC_Calendar)
        ...
        Try
            ...
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetCalendarEventByNum(ByVal calNum As Integer) As PC_Calendar
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblannouncements WHERE cNum = " & calNum
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
            ...
            Try
                ...
                If odbcReader.HasRows Then
                    ...
                    Else
                        oItem.Status = Trim(odbcReader("Status").ToString)
                    End If
					If odbcReader("website").Equals(DBNull.Value) Then
						oItem.Website = ""
					Else
						oItem.Website = Trim(odbcReader("Website").ToString())
					End If
					If odbcReader("email").Equals(DBNull.Value) Then
						oItem.EmailAddress = ""
					Else
						oItem.EmailAddress = Trim(odbcReader("email").ToString())
					End If
					If odbcReader("Address").Equals(DBNull.Value) Then
						oItem.Address = ""
					Else
						oItem.Address = Trim(odbcReader("Address").ToString())
					End If
	...
	Public Shared Function AddCalendarEvent2(ByVal oItem As PC_Calendar) As Integer
    ...
    Public Shared Function AddCalendarEvent(ByVal oItem As PC_Calendar) As Integer
        ...
        Try
            sQueryString = "INSERT INTO tblannouncements " & _
            "(Title, " & _
            "StartDate, " & _
            "EndDate, " & _
            "StartTime, " & _
            ...
            ", '" & Replace(oItem.ContactNumber, "'", "''") & _
            "', '" & Replace(oItem.Location, "'", "''") & _
			"', '" & Replace(oItem.EmailAddress, "'", "''") & _
			"', '" & Replace(oItem.Website, "'", "''") & _
			"', '" & Replace(oItem.Address, "'", "''") & _
            "', '" & Replace(oItem.Description, "'", "''") & _
            "', '" & Replace(oItem.Category, "'", "''") & _
            "', '" & Replace(oItem.fileName, "'", "''") & _
            "', 'Active'" & ")"
    ...
    Public Shared Function ModCalendarEvent(ByVal oItem As PC_Calendar) As Integer
        ...
        Try
            With oItem
                sQueryString = "UPDATE tblannouncements " & _
				...
				"', email = '" & Replace(.EmailAddress, "'", "''") & _
				"', website = '" & Replace(.Website, "'", "''") & _
