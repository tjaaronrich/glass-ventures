...
#Region "EventCalendar"
    ...
    Public Shared Function GetActiveCalendarEventsLast01() As List(Of PC_Calendar)
        ...
        Try
            ...
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
    ...
    Public Shared Function GetActiveCalendarEventsLast02() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC LIMIT 1,1"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast03() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC LIMIT 2,1"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast04() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC LIMIT 3,1"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetAllCalendarItems() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 ORDER BY Status ASC, StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEvents() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsList() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsListByName(ByVal currentName As String) As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and Title like '%" & Replace(currentName, "'", "''") & "%'"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsList2(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
			...
			'SELECT * FROM `tblannouncements` WHERE EndDate >= CURDATE() AND Status = 'Active' order BY EndDate ASC'
                
			sQueryString = "SELECT * FROM tblcalendardates WHERE EndDate >= CURDATE() AND Category = 'Event' AND Status = 'Active' order BY EndDate ASC"
			'sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and EndDate <= date_format(curdate(), '%Y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
			
			
            If fStartDate = "ALL" Or fEndDate = "ALL" Then
                'sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Else
                'sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and ((StartDate >= '" & fStartDate & "' and StartDate <= '" & fEndDate & "') or (EndDate >= '" & fStartDate & "' and EndDate <= '" & fEndDate & "')) ORDER BY StartDate ASC, StartTime ASC"
            End If
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
            ...
            Try
                ...
                While odbcReader.Read()
                    ...
                    Else
						...
						myDateString = Trim(odbcReader("StartDate").ToString)
						Dim myDate as DateTime
						DateTime.TryParse(myDateString, myDate).ToString()
						oItem.StartDate = myDate.ToString("MM/dd/yyyy")
                    ...
                    Else
						...
						myDateString = Trim(odbcReader("EndDate").ToString)
						Dim myDate as DateTime
						DateTime.TryParse(myDateString, myDate).ToString()
						oItem.EndDate = myDate.ToString("MM/dd/yyyy")
                    End If
                    'If odbcReader("EndDate").Equals(DBNull.Value) Then
                    'oItem.EndDate = ""
                    'Else
                    ...
                    Else
                        'oItem.fileName = Trim(odbcReader("fileName").ToString)
                        oItem.fileName = "<p>&nbsp;</p><a href='Documents/Calendar2Files/" & Trim(odbcReader("fileName").ToString) & "' target=_blank class='button WhiteNoU grad'>Download File</a>"
                    End If
                    If odbcReader("Status").Equals(DBNull.Value) Then
                        oItem.Status = ""
                    Else
	...
	Public Shared Function GetActiveCalendarEventsList3(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
			...
			sQueryString = "SELECT * FROM tblcalendardates WHERE EndDate >= CURDATE() AND Category = 'Specials' AND Status = 'Active' order BY EndDate ASC"
			'sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and EndDate <= date_format(curdate(), '%Y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
    ...
    Public Shared Function GetActiveCalendarEventsListHiring(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
            ...
            'Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            If fStartDate = "ALL" Or fEndDate = "ALL" Then
                sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and Category = 'Hiring' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Else
                sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and Category = 'Hiring' and ((StartDate >= '" & fStartDate & "' and StartDate <= '" & fEndDate & "') or (EndDate >= '" & fStartDate & "' and EndDate <= '" & fEndDate & "')) ORDER BY StartDate ASC, StartTime ASC"
            End If
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsListTourney2(ByVal fStartDate As String, ByVal fEndDate As String) As List(Of PC_Calendar)
        ...
        Try
            ...
            'Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            If fStartDate = "ALL" Or fEndDate = "ALL" Then
                sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and Category = 'Tournament' and EndDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            Else
                sQueryString = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and Category = 'Tournament' and ((StartDate >= '" & fStartDate & "' and StartDate <= '" & fEndDate & "') or (EndDate >= '" & fStartDate & "' and EndDate <= '" & fEndDate & "')) ORDER BY StartDate ASC, StartTime ASC"
            End If
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetInactiveCalendarEvents() As List(Of PC_Calendar)
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Inactive' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetActiveCalendarEventsLast5() As List(Of PC_Calendar)
        ...
        Try
            ...
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and StartDate >= REPLACE(CURDATE(), '-', '/') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' and StartDate >= DATE_TO_STRING(CURDATE(), '%y/%m/%d') ORDER BY StartDate ASC, StartTime ASC"
            'Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE Status = 'Active' ORDER BY StartDate ASC, StartTime ASC"
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function GetCalendarEventByNum2(ByVal calNum As Integer) As PC_Calendar
        ...
        Try
            Dim sConnString As String = ConfigurationManager.ConnectionStrings("WebApp").ConnectionString
            Dim odbcConn As OdbcConnection = New OdbcConnection(sConnString)
            Dim sQueryString As String = "SELECT * FROM tblcalendar2 WHERE cNum = " & calNum
            Dim DBCommand As New OdbcCommand(sQueryString, odbcConn)
            odbcConn.Open()
    ...
    Public Shared Function AddCalendarEvent(ByVal oItem As PC_Calendar) As Integer
        ...
        Try
            sQueryString = "INSERT INTO tblcalendar2 " & _
            "(Title, " & _
            "StartDate, " & _
            "EndDate, " & _
            "StartTime, " & _
    ...
    Public Shared Function ModCalendarEvent(ByVal oItem As PC_Calendar) As Integer
        ...
        Try
            With oItem
                sQueryString = "UPDATE tblcalendar2 " & _
    ...
    Public Shared Function DelCalendarEvent(ByVal oItem As PC_Calendar) As Integer
        ...
        Try
            With oItem
                sQueryString = "DELETE FROM tblcalendar2 WHERE cNum = " & .cNum
            End With
