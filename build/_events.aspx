  ...
  <div class="parallax">
	  <div class="container">
		<div class="row align-items-center" style="top: 35%;position: absolute;padding-left: 15px;z-index:1;">
			<div class="col-md-12">
				<h2 style="color:#ffffff;margin:0;font-size:50px;">Events</h2>
			</div>
		</div>
	  </div>
    ...
    <section id="" style="padding: 60px 0 80px;">
        <div class="container">
            <div class="row">
				...
				<asp:ObjectDataSource ID="ODS_Calendar" runat="server" SelectMethod="GetActiveCalendarEventsList2" TypeName="DAL_Calendar2" DataObjectTypeName="PC_Calendar" >
				<SelectParameters>
