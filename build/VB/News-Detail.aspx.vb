    ...
    If Not IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("nNum"))) > 0 Then
				...
				With oItem
					...
					lblTwitter.Text = "<a href='https://twitter.com/share' class='twitter-share-button' data-url='News-Detail.aspx?nNum=" & .nNum & "' data-via='EdgeAerodynamix' data-text='" & .Title & "'>Tweet</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>"
				lblFacebook.Text = "<div class='fb-like' data-href='News-Detail.aspx?nNum=" & .nNum & "' data-send='false' data-layout='button_count' data-width='100' data-show-faces='false' data-font='tahoma'></div>"
				lblMailTo.Text = "<a class='' href='mailto:?body=Take a look at this news article I found at Edge Aerodynamix, " & .Title & ". You can read it at: News-Detail.aspx?nNum=" & .nNum & "'>Email Story</a>"
