            ...
            For oo = 1 To outerLoopCnt
                ...
                If oo < outerLoopCnt Then
                    For ii = 1 To 2
                        ...
                        DisplayCode = DisplayCode & "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td background='Documents/Gallery/BigGallery/" & arrImageFile(arrCntr) & "' style='background-position:center; background-repeat:no-repeat; background-size:330px;'><a href='Documents/Gallery/BigGallery/" & arrImageFile(arrCntr) & "' target='_blank' rel='lightbox[Gallery]' title='" & arrphotoName(arrCntr) & "'><img src='Graphics/spacer.gif' alt='" & arrphotoName(arrCntr) & "' width='330' height='250' border='0'></a></td><td width='15' rowspan='2' style='background-image:url(Graphics/Fade_02.jpg); background-repeat:no-repeat; background-position:left bottom'><img src='Graphics/spacer.gif' width='15' height='15'></td></tr><tr><td height='15' style='background-image:url(Graphics/Fade_01.jpg); background-repeat:no-repeat; background-position:right top'><img src='Graphics/spacer.gif' width='15' height='15'></td></tr></table>"
