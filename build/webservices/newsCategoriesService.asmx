...
Public Sub GetCategories()
	...
	Try
		...
		Dim sQueryString As String = "SELECT * FROM tblnewscategories ORDER BY name ASC "
...
Public Sub UpdateCategory(models As String)
	...
	Dim name = x(0)("ProductName")
        ...
        Try
                ...
                sQueryString = "UPDATE tblnewscategories SET " & _
                    "name = '" & Replace(name, "'", "''") & "'  " & _
                    "WHERE pid = " & pID
...
Public Sub DeleteCategory(models As String)
	...
	Try
			...
			sQueryString = "DELETE FROM tblnewscategories WHERE pID = " & pID
...
Public Sub AddCategory(models As String)
	...
	Try
		...
		sQueryString = "INSERT INTO tblnewscategories " & _
		"(name)" & _
		" VALUES " & _
		"('" & Replace(name, "'", "''") & "')"
