        ...
        Try
            ...
            Try
                ...
                While odbcReader.Read()
                    ...
                    xmlString += """fNum"":""" & Convert.ToInt16(odbcReader("fNum")) & ""","

                    xmlString += """fSort"":""" & Trim(odbcReader("fSort").ToString) & ""","

                    xmlString += """question"":""" & Trim(odbcReader("question").ToString) & ""","

                    'xmlString += """answer"":""" & Trim(odbcReader("answer").ToString) & ""","
...
Public Sub save()
	...
	memFile.SaveAs(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & System.IO.Path.GetFileName(strFname))
...
End Sub
    ...
    <WebMethod> _
    Public Sub DeleteFaqs(models As String)
