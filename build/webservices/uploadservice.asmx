...
Public Sub saveUser()
	...
	Dim dir As String = HttpContext.Current.Request.QueryString("dir")
		
		
	Dim userPath As String = Server.MapPath("..\Documents\Accounts\Thumbs") & "\" & dir
		
		
	If Not Directory.Exists(userPath) Then
		Dim di As DirectoryInfo = Directory.CreateDirectory(userPath)
	End If
	...
	memFile.SaveAs(Server.MapPath("..\Documents\Accounts\Thumbs") & "\" & dir & "\" &
	System.IO.Path.GetFileName(strFname))
...
Public Sub saveFile()
	...
	memFile.SaveAs(Server.MapPath("..\") & dir & "\" &
	System.IO.Path.GetFileName(strFname))
...
Public Sub saveStaff()
	...
	memFile.SaveAs(Server.MapPath("..\Documents\Staff") & "\" &
	System.IO.Path.GetFileName(strFname))
...
Public Sub saveProgram()
	...
	memFile.SaveAs(Server.MapPath("..\Documents\Programs\Thumbs") & "\" &
	System.IO.Path.GetFileName(strFname))
...
Public Sub saveSlider()
	...
	memFile.SaveAs(Server.MapPath("..\Documents\Slider\Thumbs") & "\" &
	System.IO.Path.GetFileName(strFname))
