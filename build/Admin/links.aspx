              ...
              <div class="row">
				...
				var userID = '<%= Session("UserAcctNum").ToString() %>';
						var dataSource = new kendo.data.DataSource({
							transport: {
								read:  {
									url: "/webservices/linksService.asmx/GetLinksList",
									dataType: "json"
								},
								/*update: {
								...
								destroy: {
									url: "/webservices/linksService.asmx/DeleteLinks",
									dataType: "json"
								},
								/*create: {
						...
						$("#grid").kendoGrid({
							...
							toolbar: [ "create" ],
							columns: [
								{ command: [{ text: "edit link", click: showDetails}, "destroy"], title: "&nbsp;", width: "350px" },
								//"Sort",
								//"pageName"
								{ field: "linkNum", title:"ID", width: "120px" },
								{ field: "linkName", title:"Name", width: "120px" },
								{ field: "linkCategory", title:"Category", width: "120px" },
								{ field: "linkSort", title:"Sort", width: "120px" },
							...
							toolbar: [{name: "add-custom", text: "<span class='k-icon k-i-plus'></span> Add Link Item"}],
							editable:  {
								mode: "popup",
								width: "600px"
							},
							...
							remove: function(e)
							{
									var linkNum = e.model.id;
									console.log(linkNum);
									$.ajax({
											type: "POST",
											url: "/webservices/activityService.asmx/AddActivity",
											data: "{title:'Links', user:'" + FullName + "', userID:'" + userID + "', guid:'" + linkNum + "', action: 'Delete Link Item'}", 
				        ...
				        $("#grid .k-grid-add-custom").click(function(e) {
							window.location.replace("/admin/linksAdd.aspx");
						});
                    ...
                    window.location.href = "linksAdd.aspx?linkNum=" + dataItem.linkNum;
                }
