            ...
            <div id="card-stats">
              ...
              <div id="grid"></div>
				...
				<script>
					var dataSource = new kendo.data.DataSource({
						transport: {
							...
							update: {
								url: "/webservices/userservice.asmx/updateUser",
								dataType: "json"
							},
							destroy: {
								url: "/webservices/userservice.asmx/DeleteUser",
								dataType: "json"
							},
							create: {
				...
				$("#grid").kendoGrid({
					...
					toolbar: [ "create" ],
					columns: [
						{ command: ["edit", "destroy",{ text: "DELETE IMAGE", click: showDetails}], title: "&nbsp;", width: "350px" },
						{ field: "uName", title:"Username", width: "120px" },
						{ field: "passWord", title:"Password", width: "120px", editor: passwordEditor, template: "*****" },
						{ field: "PermissionLevel", title:"Permissions", width: "120px", editor: categoryDropDownEditor  },
						{ field: "fullName", title:"Full Name", width: "120px" },
						{ field: "addDate", title:"Date Added", width: "120px" },
						{ field: "ImageFile", title:"Thumb", width: "120px", editor: uploadEditor, template: "<img class='responsive-img' src='/Documents/Accounts/Thumbs/#: ImageFile #' onerror='imgError(this);' />" }
					],
					editable:  {
						mode: "popup",
						width: "600px"
				...
				function showDetails(e) {
					...
					$.ajax({
						url: "/webservices/userservice.asmx/DeleteImage?acctNum=" + dataItem.acctNum, 
