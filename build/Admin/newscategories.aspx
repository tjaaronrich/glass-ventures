              ...
              <div id="grid"></div>
				...
				<script>
					var dataSource = new kendo.data.DataSource({
						transport: {
							...
							update: {
								url: "/webservices/newscategoriesService.asmx/UpdateCategory",
								dataType: "json"
							},
							destroy: {
								url: "/webservices/newscategoriesService.asmx/DeleteCategory",
								dataType: "json"
							},
							create: {
				...
				$("#grid").kendoGrid({
					...
					columns: [
						...
						//{ field: "ProductID", title:"Name", width: "120px" },
				...
				var categories = [
					{ "CategoryID": "Location", "CategoryName": "Location" }
				];
