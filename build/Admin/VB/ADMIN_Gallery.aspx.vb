...
Partial Class ADMIN_Gallery
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For iPhoto = 1 To 5
            ...
            If iPhoto = 4 Then
                Name = txtName4.Text
                GalleryID = Convert.ToInt16(ddlGallery4.SelectedValue)
                Gallery = ddlGallery4.SelectedItem.Text
                'If Len(Name) > 1 Then
                    ImageFile = GalleryID & "-" & FileUpload4.FileName
                'End If
            ...
            If iPhoto = 5 Then
                Name = txtName5.Text
                GalleryID = Convert.ToInt16(ddlGallery5.SelectedValue)
                Gallery = ddlGallery5.SelectedItem.Text
                'If Len(Name) > 1 Then
                    ImageFile = GalleryID & "-" & FileUpload5.FileName
                'End If
            ...
            'If Len(Name) > 1 Then
                ...
                If FileOK = 1 Then
                    ...
                    cnt = DAL_Gallery.FileNameExists(ImageFile)

                    If cnt = 0 Then

                        Rslt = DAL_Gallery.AddPhoto(Name, ImageFile, GalleryID, Gallery, Status)
                        ...
                        If Rslt = 1 Then
                            ...
                            Try
                                ...
                                End If
                                If iPhoto = 4 Then
                                    FileUpload4.SaveAs(Server.MapPath("..\Documents\Gallery") & "\" & GalleryID & "-" & FileUpload4.FileName)
                                    Img = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Gallery") & "\" & GalleryID & "-" & FileUpload4.FileName)
                                    Img2 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Gallery") & "\" & GalleryID & "-" & FileUpload4.FileName)
                                End If
                                If iPhoto = 5 Then
                                    FileUpload5.SaveAs(Server.MapPath("..\Documents\Gallery") & "\" & GalleryID & "-" & FileUpload5.FileName)
                                    Img = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Gallery") & "\" & GalleryID & "-" & FileUpload5.FileName)
                                    Img2 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Gallery") & "\" & GalleryID & "-" & FileUpload5.FileName)
                                End If


                                ThumbSize = ThumbNailSize(Img.Height, Img.Width, 370, "W")
                                ...
                                End If
                                If iPhoto = 4 Then
                                    NewThumb.Save(Server.MapPath("..\Documents\Gallery\Thumbs") & "\" & GalleryID & "-" & FileUpload4.FileName)
                                End If
                                If iPhoto = 5 Then
                                    NewThumb.Save(Server.MapPath("..\Documents\Gallery\Thumbs") & "\" & GalleryID & "-" & FileUpload5.FileName)
                                End If

                                'NewThumb.Save(Server.MapPath("Documents\Gallery\Thumbs") & "\" & FileUpload1.FileName)


                                ThumbSize2 = ThumbNailSize2(Img2.Height, Img2.Width, 700, "W")
                                ...
                                End If
                                If iPhoto = 4 Then
                                    NewThumb2.Save(Server.MapPath("..\Documents\Gallery\BigGallery") & "\" & GalleryID & "-" & FileUpload4.FileName)
                                End If
                                If iPhoto = 5 Then
                                    NewThumb2.Save(Server.MapPath("..\Documents\Gallery\BigGallery") & "\" & GalleryID & "-" & FileUpload5.FileName)
                                End If
    ...
    Protected Sub btnAddGallery_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddGallery.Click
        ...
        gExist = DAL_Gallery.GalleryNameExists(txtNewGallery.Text)
        ...
        If gExist = 0 Then
            ...
            Rslt = DAL_Gallery.AddPhotoGallery(txtNewGallery.Text, "NO", "Active")
        End If
        ...
        If Rslt = 1 Then
            ...
            ddlGallery4.DataBind()
            ddlGallery5.DataBind()
        End If
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Response.Redirect("EditPhoto.aspx?photoID=" & photoID)
    End Sub
End Class
