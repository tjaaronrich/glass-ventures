...
Partial Class YourAttractionListingAdd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("pID"))) > 0 Then
				...
				oItem = DAL_Listing.GetAttractionInfoByID(pID)
				...
				With oItem
					...
					thumb0.ImageUrl = "../Documents/Attractions/Thumbs/" & .ImageFile1
					thumb1.ImageUrl = "../Documents/Attractions/Thumbs/" & .ImageFile2
					thumb2.ImageUrl = "../Documents/Attractions/Thumbs/" & .ImageFile3
					thumb3.ImageUrl = "../Documents/Attractions/Thumbs/" & .ImageFile4
					thumb4.ImageUrl = "../Documents/Attractions/Thumbs/" & .ImageFile5
					thumb5.ImageUrl = "../Documents/Attractions/Thumbs/" & .ImageFile6
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        ...
        If Len(txtpName.Text) > 1 Then
            ...
            'If FileUpload1.HasFile or FileUpload2.HasFile Then
                ...
                'If cnt = 0 Then
					If SaveButton.Text = "Update Item" Then
						Rslt = DAL_Listing.ModifyAttraction(oItem)
					End If
	
					If SaveButton.Text = "Add Item" Then
						Rslt = DAL_Listing.AddAttractionListing(oItem, Session("UserAcctNum").ToString())
					End If
                    ...
                    'If Rslt = 1 Then
						...
						If FileUpload0.HasFile Then
                        Try
                        FileUpload0.SaveAs(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload0.FileName)
                        Img0 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload0.FileName)
                        ...
                        NewThumb0.Save(Server.MapPath("..\Documents\Attractions\Thumbs") & "\" & FileUpload0.FileName)
						...
						If FileUpload1.HasFile Then
                        Try
                        FileUpload1.SaveAs(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload1.FileName)
                        Img1 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload1.FileName)
                        ...
                        NewThumb1.Save(Server.MapPath("..\Documents\Attractions\Thumbs") & "\" & FileUpload1.FileName)
						...
						If FileUpload2.HasFile Then
                        Try
                        FileUpload2.SaveAs(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload2.FileName)
                        Img2 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload2.FileName)
                        ...
                        NewThumb2.Save(Server.MapPath("..\Documents\Attractions\Thumbs") & "\" & FileUpload2.FileName)
						...
						If FileUpload3.HasFile Then
                        Try
                        FileUpload3.SaveAs(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload3.FileName)
                        Img3 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload3.FileName)
                        ...
                        NewThumb3.Save(Server.MapPath("..\Documents\Attractions\Thumbs") & "\" & FileUpload3.FileName)
						...
						If FileUpload4.HasFile Then
                        Try
                        FileUpload4.SaveAs(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload4.FileName)
                        Img4 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Attractions") & "\" & FileUpload4.FileName)
                        ...
                        NewThumb4.Save(Server.MapPath("..\Documents\Attractions\Thumbs") & "\" & FileUpload4.FileName)
        ...
        Response.Redirect("Your-Attraction-Listing.aspx")
