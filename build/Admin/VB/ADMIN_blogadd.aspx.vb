        ...
        If Not Page.IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("nNum"))) > 0 Then
				...
				With oItem
					...
					thumb.ImageUrl = "Documents/News/BigNews/" & .ImageFile
        ...
        If Len(txtTitle.Text) > 1 Then
            ...
            'If FileUpload1.HasFile Then
                ...
                With oItem
					...
					End If
					If SaveButton.Text = "Update Blog Item" Then
						.nNum = lblBlogNum.Text
                    End If
                End With
                ...
                'If cnt = 0 Then
					...
					If SaveButton.Text = "Add Blog Item" Then
                    ...
                    'If Rslt = 1 Then
                        ...
                        'ThumbSize = ThumbNailSize(Img.Height, Img.Width, 575, "W")
                        ...
                        'Response.Redirect("ADMIN_blog.aspx")
