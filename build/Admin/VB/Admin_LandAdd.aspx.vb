    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("nNum"))) > 0 Then
				...
				oItem = DAL_NewsFTB.GetLandByNum(nNum)
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        ...
        If Len(txtTitle.Text) > 1 Then
            ...
            If FileUpload1.HasFile Then
                ...
                If cnt = 0 Then
					If SaveButton.Text = "Update News Item" Then
						Rslt = DAL_NewsFTB.ModLand(oItem)
					End If
	
					If SaveButton.Text = "Add News Item" Then
						Rslt = DAL_NewsFTB.AddLand(oItem)
					End If
                    ...
                    If Rslt = 1 Then
                        ...
                        Response.Redirect("Admin_Land.aspx")
