    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		lblEndDate.Text = Trim(Left(nowDate, instr(nowDate, " ")))
			...
			If Len(Server.HtmlDecode(Request.QueryString("cNum"))) > 0 Then
				...
				oItem = DAL_CalendarDates.GetCalendarEventByNum(cNum)
        ...
        With oItem
			...
			lblfileName.Text = "<a href='../Documents/CalendarFiles/" & .fileName & "' target=_blank>" & .fileName & "</a>"
...
.EndDate = datepicker2.Value
        ...
        If SaveButton.Text = "Update Item" Then
			Rslt = DAL_CalendarDates.ModCalendarEvent(oItem)
            txtTitle.Text = ""
        ...
        Else
			Rslt = DAL_CalendarDates.AddCalendarEvent(oItem)
