...
Public Class NewsArchiveDetail 
    ...
    If Not IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("nNum"))) > 0 Then
				...
				With oItem
					...
					lblTwitter.Text = "<a href='https://twitter.com/share' class='twitter-share-button' data-url='http://www.aawob-gyn.com/News-Archive-Detail.aspx?nNum=" & .nNum & "' data-via='BICPC' data-text='" & .Title & "'>Tweet</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>"
					lblFacebook.Text = "<div class='fb-like' data-href='http://www.aawob-gyn.com/News-Archive-Detail.aspx?nNum=" & .nNum & "' data-send='false' data-layout='button_count' data-width='100' data-show-faces='false' data-font='tahoma'></div>"
					lblMailTo.Text = "<a href='mailto:?body=Take a look at this story I found at Business Innovation Center, " & .Title & ". You can read it at: http://www.aawob-gyn.com/News-Archive-Detail.aspx?nNum=" & .nNum & "'>Email Story</a>"
