    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Try
                ...
                Dim sQueryString As String = "SELECT * FROM tblftb WHERE pageName = 'Index'"
                ...
                Try
                   ...
                   'txtPageName.Text = odbcReader("pageName").ToString()
					...
					'pageName value should be coded to match the name of the page where the content is to be loaded
					Dim sQueryString2 As String = "SELECT * FROM tblftb WHERE pageName = 'Index2'"
	
					Dim DBCommand2 As New OdbcCommand(sQueryString2, odbcConn)
					odbcConn.Open()

                    Dim odbcReader2 As OdbcDataReader = DBCommand.ExecuteReader(CommandBehavior.CloseConnection)
                    odbcReader2.Read()
