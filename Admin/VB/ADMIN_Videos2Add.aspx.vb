...
Partial Class Admin_Videos2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Dim sortmax As Integer = 0
			...
			If Len(Server.HtmlDecode(Request.QueryString("vNum"))) > 0 Then
				...
				Dim oItem As New PC_Videos_Universal
		
				oItem = DAL_Videos_Universal.GetVideosByNum(vNum)
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        ...
        If SaveButton.Text = "Update Videos" Then
            Rslt = DAL_Videos_Universal.ModVideos(oItem)
            txtvTitle.Text = ""
        ...
        Else
            Rslt = DAL_Videos_Universal.AddVideos(oItem)
            txtvTitle.Text = ""
            txtvDescription.Text = ""
            txtCredits.Text = ""
            txtYouTubeID.Text = ""
