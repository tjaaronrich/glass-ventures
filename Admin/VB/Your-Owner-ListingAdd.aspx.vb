...
Partial Class YourOwnerListingAdd
...
Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If Not Page.IsPostBack Then
		...
		If Len(Server.HtmlDecode(Request.QueryString("pID"))) > 0 Then
			...
			oItem = DAL_Listing.GetOwnerInfoByID(pID)
			...
			With oItem
				...
				Editor1.innerHtml = HttpUtility.HtmlDecode(.pDescription)
                Editor2.innerHtml = HttpUtility.HtmlDecode(.pFeatures)
				Sort.Value = .pSort
				'ddlStatus.SelectedValue = .Status
				cStatus = .Status
				thumb0.ImageUrl = "../Documents/Owners/Thumbs/" & .ImageFile1
				thumb1.ImageUrl = "../Documents/Owners/Thumbs/" & .ImageFile2
				thumb2.ImageUrl = "../Documents/Owners/Thumbs/" & .ImageFile3
				thumb3.ImageUrl = "../Documents/Owners/Thumbs/" & .ImageFile4
				thumb4.ImageUrl = "../Documents/Owners/Thumbs/" & .ImageFile5
				thumb5.ImageUrl = "../Documents/Owners/Thumbs/" & .ImageFile6
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        ...
        If Len(txtpName.Text) > 1 Then
            ...
            'If FileUpload1.HasFile or FileUpload2.HasFile Then
                ...
                With oItem
					...
					.pDescription = Editor1.innerHtml
                    .pFeatures = Editor2.innerHtml
					.pSort = Convert.toInt32(Sort.Value)
					...
					If activeSwitch.Checked = True Then
						.Status = "Active"
					Else
						.Status = "Inactive"
					End If
                ...
                'If cnt = 0 Then
					If SaveButton.Text = "Update Item" Then
						Rslt = DAL_Listing.ModifyOwner(oItem)
					End If
	
					If SaveButton.Text = "Add Item" Then
						Rslt = DAL_Listing.AddOwnerListing(oItem, Session("UserAcctNum").ToString())
					End If
                    ...
                    'If Rslt = 1 Then
						...
						If FileUpload0.HasFile Then
                        Try
                        FileUpload0.SaveAs(Server.MapPath("..\Documents\Owners") & "\" & FileUpload0.FileName)
                        Img0 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Owners") & "\" & FileUpload0.FileName)
                        ...
                        NewThumb0.Save(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & FileUpload0.FileName)
						...
						If FileUpload1.HasFile Then
                        Try
                        FileUpload1.SaveAs(Server.MapPath("..\Documents\Owners") & "\" & FileUpload1.FileName)
                        Img1 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Owners") & "\" & FileUpload1.FileName)
                        ...
                        NewThumb1.Save(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & FileUpload1.FileName)
						...
						If FileUpload2.HasFile Then
                        Try
                        FileUpload2.SaveAs(Server.MapPath("..\Documents\Owners") & "\" & FileUpload2.FileName)
                        Img2 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Owners") & "\" & FileUpload2.FileName)
                        ...
                        NewThumb2.Save(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & FileUpload2.FileName)
						...
						If FileUpload3.HasFile Then
                        Try
                        FileUpload3.SaveAs(Server.MapPath("..\Documents\Owners") & "\" & FileUpload3.FileName)
                        Img3 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Owners") & "\" & FileUpload3.FileName)
                        ...
                        NewThumb3.Save(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & FileUpload3.FileName)
						...
						If FileUpload4.HasFile Then
                        Try
                        FileUpload4.SaveAs(Server.MapPath("..\Documents\Owners") & "\" & FileUpload4.FileName)
                        Img4 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Owners") & "\" & FileUpload4.FileName)
                        ...
                        NewThumb4.Save(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & FileUpload4.FileName)
						...
						If FileUpload5.HasFile Then
                        Try
                        FileUpload5.SaveAs(Server.MapPath("..\Documents\Owners") & "\" & FileUpload5.FileName)
                        Img5 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Owners") & "\" & FileUpload5.FileName)
                        ...
                        NewThumb5.Save(Server.MapPath("..\Documents\Owners\Thumbs") & "\" & FileUpload5.FileName)
        ...
        Response.Redirect("Your-Owner-Listing.aspx")
