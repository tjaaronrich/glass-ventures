...
Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If Not Page.IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("ftbNum"))) > 0 Then
				...
				oItem = DAL_Widgets.GetPageNameByNum(ftbNum)

				With oItem
				txtpageName.Text = .widgetName
					 
					Editor1RTE.Text = .content
					Editor1.innerHtml = .content
				End With
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
		...
		If Len(txtpageName.Text) > 1 Then
            ...
            'If FileUpload1.HasFile or FileUpload2.HasFile Then
				...
				Dim cStatus As String
                With oItem
					.widgetName = txtpageName.Text
		
					.content = Editor1RTE.Text
                ...
                'If cnt = 0 Then
					...
					If SaveButton.Text = "Update Item" Then
						nResult = DAL_Widgets.ModifyPage(oItem)
					End If
	
					If SaveButton.Text = "Add Item" Then
						Rslt = DAL_Widgets.AddPage(oItem)
						nResult = "Here"
					End If
					strError = nResult
                    'If Rslt = 1 Then
