...
Partial Class Admin_Links
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Dim sortmax As Integer = 0
			...
			If Len(Server.HtmlDecode(Request.QueryString("linkNum"))) > 0 Then
				...
				oItem = DAL_ResourceLinks.GetLinksByNum(linkNum)
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        ...
        If SaveButton.Text = "Update Link Item" Then
            Rslt = DAL_ResourceLinks.ModLinks(oItem)
            txtlinkName.Text = ""
            txtURL.Text = ""
            txtlinkDescription.Text = ""
            'ddllinkCategory.SelectedIndex = ddllinkCategory.SelectedValue
            ddllinkCategory.SelectedIndex = ddllinkCategory.Items.IndexOf(ddllinkCategory.Items.FindByValue("Services for Individuals"))
            'pnlStatus.Visible = True
            SaveButton.Text = "Update Link Item"
        Else
            Rslt = DAL_ResourceLinks.AddLinks(oItem)
            txtlinkName.Text = ""
            txtURL.Text = ""
            txtlinkDescription.Text = ""
            'ddllinkCategory.SelectedIndex = ddllinkCategory.SelectedValue
        ...
        End If
			Response.Redirect("ADMIN_ResourceLinks.aspx")
        'GridView1.DataBind()
