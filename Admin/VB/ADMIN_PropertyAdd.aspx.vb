...
Partial Class ADMIN_PropertyAdd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
			...
			If Len(Server.HtmlDecode(Request.QueryString("pID"))) > 0 Then
				...
				Dim oItem As New PC_Property
		
				oItem = DAL_Property.GetPropertyInfoByID(pID)
				...
				With oItem
					...
					thumb0.ImageUrl = "../Documents/Property/Thumbs/" & .ImageFile1
					thumb1.ImageUrl = "../Documents/Property/Thumbs/" & .ImageFile2
					thumb2.ImageUrl = "../Documents/Property/Thumbs/" & .ImageFile3
					thumb3.ImageUrl = "../Documents/Property/Thumbs/" & .ImageFile4
					thumb4.ImageUrl = "../Documents/Property/Thumbs/" & .ImageFile5
					thumb5.ImageUrl = "../Documents/Property/Thumbs/" & .ImageFile6
			...
			Else 
                ...
                sortmax = DAL_Property.GetMaxSortNumber()
                sortmax = sortmax + 1
    ...
    Protected Sub SaveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        ...
        If Len(txtpName.Text) > 1 Then
            ...
            'If FileUpload1.HasFile or FileUpload2.HasFile Then
                ...
                'If cnt = 0 Then
					If SaveButton.Text = "Update Item" Then
						Rslt = DAL_Property.ModifyProperty(oItem)
					End If
	
					If SaveButton.Text = "Add Item" Then
						Rslt = DAL_Property.AddProperty(oItem)
					End If
                    ...
                    'If Rslt = 1 Then
						...
						If FileUpload0.HasFile Then
                        Try
                        FileUpload0.SaveAs(Server.MapPath("..\Documents\Property") & "\" & FileUpload0.FileName)
                        Img0 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Property") & "\" & FileUpload0.FileName)
                        ...
                        NewThumb0.Save(Server.MapPath("..\Documents\Property\Thumbs") & "\" & FileUpload0.FileName)
						...
						If FileUpload1.HasFile Then
                        Try
                        FileUpload1.SaveAs(Server.MapPath("..\Documents\Property") & "\" & FileUpload1.FileName)
                        Img1 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Property") & "\" & FileUpload1.FileName)
                        ...
                        NewThumb1.Save(Server.MapPath("..\Documents\Property\Thumbs") & "\" & FileUpload1.FileName)
						...
						If FileUpload2.HasFile Then
                        Try
                        FileUpload2.SaveAs(Server.MapPath("..\Documents\Property") & "\" & FileUpload2.FileName)
                        Img2 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Property") & "\" & FileUpload2.FileName)
                        ...
                        NewThumb2.Save(Server.MapPath("..\Documents\Property\Thumbs") & "\" & FileUpload2.FileName)
						...
						If FileUpload3.HasFile Then
                        Try
                        FileUpload3.SaveAs(Server.MapPath("..\Documents\Property") & "\" & FileUpload3.FileName)
                        Img3 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Property") & "\" & FileUpload3.FileName)
                        ...
                        NewThumb3.Save(Server.MapPath("..\Documents\Property\Thumbs") & "\" & FileUpload3.FileName)
						...
						If FileUpload4.HasFile Then
                        Try
                        FileUpload4.SaveAs(Server.MapPath("..\Documents\Property") & "\" & FileUpload4.FileName)
                        Img4 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Property") & "\" & FileUpload4.FileName)
                        ...
                        NewThumb4.Save(Server.MapPath("..\Documents\Property\Thumbs") & "\" & FileUpload4.FileName)
						...
						If FileUpload5.HasFile Then
                        Try
                        FileUpload5.SaveAs(Server.MapPath("..\Documents\Property") & "\" & FileUpload5.FileName)
                        Img5 = System.Drawing.Image.FromFile(Server.MapPath("..\Documents\Property") & "\" & FileUpload5.FileName)
                        ...
                        NewThumb5.Save(Server.MapPath("..\Documents\Property\Thumbs") & "\" & FileUpload5.FileName)
        ...
        Response.Redirect("ADMIN_Property.aspx")
