                ...
                <div class="col s12">
            		...
            		<script>
						...
						var dataSource = new kendo.data.DataSource({
							transport: {
								read:  {
									url: "/webservices/announcementService.asmx/GetAnnouncementList",
									dataType: "json"
								},
								update: {
									url: "/webservices/announcementService.asmx/UpdateAnnouncement",
									dataType: "json"
								},
								destroy: {
									url: "/webservices/announcementService.asmx/DeleteAnnouncement",
									dataType: "json"
								},
								create: {
									url: "/webservices/announcementService.asmx/AddAnnouncement",
									dataType: "json"
								},
						...
						$("#grid").kendoGrid({
							...
							toolbar: [ "create" ],
							columns: [
								{ command: [{name: 'test', text: "<span class='k-icon k-i-edit'></span>edit", click: showDetails}, "destroy"], title: "&nbsp;", width: "250px" },
								//"Sort",
								//"pageName"
								{ field: "Category", title:"Category", width: "120px" },
								{ field: "Title", title:"Title", width: "120px" },
								{ field: "StartDate", title:"Start Date", width: "120px" },
								{ field: "EndDate", title:"End Date", width: "120px" },
							...
							toolbar: [{name: "add-custom", text: "<span class='k-icon k-i-plus'></span> Add Events"}],
							save: function(e,c){
				        ...
				        $("#grid .k-grid-add-custom").click(function(e) {
							window.location.replace("/admin/announcementsAdd.aspx");
						});
						
				        $("#grid .k-grid-edit").click(function(e) {
							console.log('test');
							e.preventDefault();
							window.location.replace("/admin/announcementsAdd.aspx");
						});
						...
						function showDetails(e) {
							...
							window.location.href = "announcementsAdd.aspx?cNum=" + dataItem.cNum;
                		}
