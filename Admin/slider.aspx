              ...
              <div id="grid"></div>
				...
				<script>
					var dataSource = new kendo.data.DataSource({
						transport: {
							read:  {
								url: "/webservices/sliderService.asmx/GetSlider",
								dataType: "json"
							},
							update: {
								url: "/webservices/sliderService.asmx/UpdateSlider",
								dataType: "json"
							},
							destroy: {
								url: "/webservices/sliderService.asmx/DeleteSlider",
								dataType: "json"
							},
							create: {
								url: "/webservices/sliderService.asmx/AddSlider",
								dataType: "json"
							},
				...
				$("#grid").kendoGrid({
					...
					toolbar: [ "create" ],
					columns: [
						{ command: ["edit", "destroy",{ text: "edit content", click: showDetails},], title: "&nbsp;", width: "350px" },
						...
						{ field: "backgroundImageFile", title:"Background", width: "120px", editor: uploadBackgroundEditor, template: "<img class='responsive-img' src='/Documents/Slider/Thumbs/#: backgroundImageFile #' />" },
				...
				function uploadEditor(container, options) {
					...
					$("<input type='file' id='files' data-role='upload'  data-success='onSuccess' name='files' />")
						...
						.kendoUpload({
							async: {
								saveUrl: "/webservices/uploadservice.asmx/saveSlider",
								removeUrl: "remove",
								autoUpload: true
							},
						success: onSuccess
				...
				function onBackgroundSuccess(e){	
			   	...
			   	function showDetails(e) {
                    ...
                    window.location.href = "SliderEdit.aspx?pID=" + dataItem.pID;
                }
