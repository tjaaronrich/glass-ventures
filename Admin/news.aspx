				...
				var userID = '<%= Session("UserAcctNum").ToString() %>';
						...
						var dataSource = new kendo.data.DataSource({
							...
							transport: {
								...
								read:  {
									...
									url: "/webservices/newsService.asmx/GetNewsList",
								...
								destroy: {
									...
									url: "/webservices/newsService.asmx/DeleteNews",
						...
						$("#grid").kendoGrid({
							...
							columns: [
								...
								{ command: [{ text: "edit blog", click: showDetails}, "destroy"], title: "&nbsp;", width: "350px" },
								...
								{ field: "ItemDate", title:"Item Date", width: "120px" },
							...
							toolbar: [{name: "add-custom", text: "<span class='k-icon k-i-plus'></span> Add News/Blog Item"}],
...

							{
									...
									$.ajax({
											...
											data: "{title:'News/Blog', user:'" + FullName + "', userID:'" + userID + "', guid:'" + nNum + "', action: 'Delete News Item'}", 
				        ...
				        $("#grid .k-grid-add-custom").click(function(e) {
							...
							window.location.replace("/admin/newsAdd.aspx");
                    ...
                    window.location.href = "newsAdd.aspx?nNum=" + dataItem.nNum;
