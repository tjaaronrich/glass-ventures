<%@ Page Language="VB" Debug="true" AutoEventWireup="false" CodeFile="VB/calendarAdd.aspx.vb" Inherits="CalendarAdd" validateRequest="false" %>
			...
			$(document).ready(function() {
				...
				$("#SaveButton").click(function(){
					$.ajax({
							...
							data: "{title:'Calendar', user:'" + FullName + "', userID:'" + userID + "', guid:'" + guid + "', action: '" + action + "'}", 
						...
						<div class="col s12">
							...
							<div class="col s12">
								<p>&nbsp;</p>
								<asp:LinkButton ID="SaveButton" runat="server" Text="Add Item" CssClass="waves-effect waves-light btn btn-large  box-shadow btn-opt1" />
								<p>&nbsp;</p>
