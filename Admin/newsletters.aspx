              ...
              <div id="grid"></div>
				...
				$("#grid").kendoGrid({
					...
					columns: [
						...
						{ field: "ImageFile", title:"Thumb", width: "120px", editor: uploadEditor, template: "<a href='/Documents/newsletter/Thumbs/#: ImageFile #' onerror='imgError(this);' >#: ImageFile #</a>" }
					...
					$("<input type='file' id='files' data-role='upload'  data-success='onSuccess' name='files' />")
						...
						.kendoUpload({
							...
							async: {
								...
								saveUrl: "/webservices/uploadservice.asmx/saveFile?dir=" + "%2FDocuments%2FNewsletter%2FThumbs",
				...
				function showDetails(e) {
					...
					$.ajax({
						...
						url: "/webservices/newsletterservice.asmx/DeleteImage?nNum=" + dataItem.nNum, 
